...
export default function Animal ({ animal }) {
    ...
    const [deleteAnimal, { loading, error, data }] = useMutation(DELETE_ANIMAL_MUTATION);
                    ...
                    <main className="py-10">
                        <div
                            ...
                            <div
                                ...
                                <button type="button"
                                        onClick={() => {
                                            handleDelete().then(() => { router.push('/animals') });
                                        }}
